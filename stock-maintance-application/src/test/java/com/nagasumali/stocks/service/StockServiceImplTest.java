...
import static com.nagasumali.stocks.makers.StockMaker._ValidStock;
import static com.nagasumali.stocks.makers.StockMaker._symbol;
...
public class StockServiceImplTest {
    ...
    public void shouldCalculateStockPriceFromPastMinutes() {
        Trade trade1 = make(a(TradeMaker._ValidTrade, with(TradeMaker._price, 10.0), with(TradeMaker._quantity, 1)));
        Trade trade2 = make(a(TradeMaker._ValidTrade, with(TradeMaker._price, 20.0), with(TradeMaker._quantity, 2)));
        Trade trade3 = make(a(TradeMaker._ValidTrade, with(TradeMaker._price, 30.0), with(TradeMaker._quantity, 5)));
    ...
    public void shouldThrowExceptionWhenCalculatingStockPriceAndQuantitySumIsZero() {
        Trade trade1 = make(a(TradeMaker._ValidTrade, with(TradeMaker._price, 10.0), with(TradeMaker._quantity, 0)));
        Trade trade2 = make(a(TradeMaker._ValidTrade, with(TradeMaker._price, 20.0), with(TradeMaker._quantity, 0)));
        Trade trade3 = make(a(TradeMaker._ValidTrade, with(TradeMaker._price, 30.0), with(TradeMaker._quantity, 0)));
